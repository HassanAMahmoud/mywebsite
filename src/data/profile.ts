export const profile = {
  ...
  headline:
    "Flexible and printable wireless sensors for structural, wearable, and environmental monitoring",
  affiliation:
  ...
  interests: [
    ...
    "Printed electronics and micro/nano-fabrication for sensing",
    "Laser-induced graphene and thermoelectric flexible sensors",
    "Wearable and human–machine interface sensing",
    "Mechanics of composite materials and bonded joints",
    "IoT-enabled wireless monitoring for energy infrastructure",
  ],
  about: `Hello! I am Hassan A. Mahmoud, a Postdoctoral Fellow in the Mechanics of Composites for Energy and Mobility (MCEM) Lab at King Abdullah University of Science and Technology (KAUST). My research focuses on multifunctional printed sensing technologies and wireless monitoring solutions for composite and non-metallic infrastructure, in collaboration with industry partners including Saudi Aramco.`,
...
During my PhD, I developed printable and e-tattoo wireless strain sensors, cracked-based RFID sensors, laser-induced graphene temperature sensors, and wearable capacitive sensing platforms. I have also contributed to research on composite joint toughness and worked with Saudi Aramco on high-precision wireless gauges for structural health monitoring.

I am currently leading work on fully printable wireless piezoelectric sensing platforms, nanoparticle-functionalized laser-induced graphene for flexible thermal applications, and sensing technologies for inspection of non-metallic pipelines under the ENERCOMP consortium.`,
  education: [
    {
